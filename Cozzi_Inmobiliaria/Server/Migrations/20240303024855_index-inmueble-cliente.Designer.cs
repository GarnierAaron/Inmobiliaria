...
namespace Cozzi_Inmobiliaria.Server.Migrations
{
    ...
    [Migration("20240303024855_index-inmueble-cliente")]
    partial class indexinmueblecliente
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cozzi_Inmobiliaria.Shared.Models.Cliente", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cozzi_Inmobiliaria.Shared.Models.Inmueble", b =>
                {
                    b.HasOne("Cozzi_Inmobiliaria.Shared.Models.Cliente", "Cliente")
                        .WithMany("Inmuebles")
